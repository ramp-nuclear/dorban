...
def test_partially_poisened():
    ...
    """
    geo = Cartesian(lengths=[[21, 21, 21]],
                    boundary_condition=[Reflector(),
                                        Reflector()]).to_polybox()
    A = Fissionable("A", scatter=np.array([[0, 0], [0.017, 0]]),
                    absorb=np.array([0.009, 0.08]),
                    nusigmaf=np.array([0.006, 0.104]),
                    chi=np.array([1, 0]),
                    diffusion=np.array([1.32, 0.383]))
    B = Fissionable("B", scatter=np.array([[0, 0], [0.017, 0]]),
                    absorb=np.array([0.009, 0.09]),
                    nusigmaf=np.array([0.006, 0.104]),
                    chi=np.array([1, 0]),
                    diffusion=np.array([1.32, 0.383]))
    A_B = Fissionable("AB", scatter=np.array([[0, 0], [0.017, 0]]),
    ...
    discontinuity = np.array(
        [[[1, 1], [1, 1]], [[1.036, 1.0856], [0.9508, 0.8919]],
         [[1, 1], [1, 1]]])
